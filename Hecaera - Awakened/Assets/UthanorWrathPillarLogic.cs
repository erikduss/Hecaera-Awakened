...
namespace Erikduss
{
    public class UthanorWrathPillarLogic : NetworkBehaviour
    {
        ...
        public void ReturnThisProjectileToPool()
        {
            ...
            WorldNetworkObjectPoolManager.Instance.m_PooledObjects[WorldNetworkObjectPoolManager.Instance.GetGameObjectWithPoolType(PooledObjectType.UthanorWrathPillar)].Release(netObj);
        }
