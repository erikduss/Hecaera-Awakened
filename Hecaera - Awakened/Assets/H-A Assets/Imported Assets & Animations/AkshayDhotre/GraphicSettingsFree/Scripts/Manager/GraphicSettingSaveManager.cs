...
namespace AkshayDhotre.GraphicSettingsMenu
{
    ...
    public class GraphicSettingSaveManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            defaultDataContainer.screenHeight = 1080;
            defaultDataContainer.screenWidth = 1920;
            defaultDataContainer.screenMode = 0;
            defaultDataContainer.qualityLevel = 0;

            defaultDataContainer.mainVolume = 25;
            defaultDataContainer.musicVolume = 25;
            defaultDataContainer.sfxVolume = 50;
            defaultDataContainer.dialogVolume = 50;
